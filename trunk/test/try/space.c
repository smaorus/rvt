...
main(int argc, char *argv[])
{
	...
	simpol(group_ptr);
	//printf("%f", group_ptr->GEOMNODE_PTR->GEOMPORT_PTR->PHEPOL);
	waitcont();
...
)
{
	...
	//printf("%f", (gnode_ptr->GEOMPORT_PTR)->PPA); //should remove this line
...
)
{
	...
	*curr_ptr = p1;
	...
	if (error != 0) {
		...
		//printf ("%c \n", *curr_ptr); // should remove this line
		//printf ("%f \n", *angle_ptr); // should remove this line
	    //printf ("%d \n", *angle_unit_ptr); // should remove this line
	    //printf ("%f \n", *pstep_ptr); // should remove this line
	    //printf ("%f \n", *qstep_ptr); // should remove this line
		if (error == 17) {
			*grid_ptr = NULL;
			printf("\n%s", ErrorMessages[16]);
			return 17;
...
)
{
	...
	//printf("%f", E); // should remove this line
	...
	// while (geomnode_app_ptr != NULL) {
		...
		//while (port_app_ptr != NULL) {
			...
			//printf("%f", app_ptr->AMP); // should remove this line
			//printf("%f", geomnode_app_ptr->XA); // should remove this line
			//printf("%f", geomnode_app_ptr->YA); // should remove this line
...
simpol(struct Group * group_ptr)
{
	...
	while (geomnode_app_ptr != NULL) {
		...
		while (port_app_ptr != NULL) {
			...
			//printf("%f", geomport_app_ptr->PHEPOL); // should remove this line
	...
	//printf("%f", port_app_ptr->PHEPOL); // should remove this line
	//printf("%f", geomport_app_ptr->PHEPOL); // should remove this line
