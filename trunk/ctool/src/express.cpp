...
{
    function = func;
	if( func && func->etype == ET_Variable) {
		if (RVParse::supplied_by_rvt(((Variable*)func)->name->name)) 
			RVGlob::counters(RVGlob::GLBL_EXTERNAL_INPUTS, RVGlob::counters(RVGlob::GLBL_EXTERNAL_INPUTS) + 1); // increase the count of external inputs by 1
	}	
}
