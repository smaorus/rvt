...
void  __CPROVER_assume(_Bool  rv_arg_30);
...
void  __CPROVER_assume(_Bool  rv_arg_31);
...
int  rvs1_F(int  *n)
{
  ...
  if( found ) /* input values were found among the saved values */
  {
   /* Sides 0 and 1 are partially equivalent.
    * Returning the results of side 0: */
  *n = *rv_UF_F_array[found_ind].out_n;	/* Generated by:  gen_input_found_case(608)/ protect_pointer [op=5](613)(379)(284)/ rv_temps.cpp:362*/
  retval = rv_UF_F_array[found_ind].out_retval;	/* Generated by:  gen_input_found_case(608)/ protect_pointer [op=5](613)(379)(284)(608)(613)(379)(284)/ rv_temps.cpp:362*/
