...
typedef int  (*rvt_FuncPtrSubst_int__const_void_ptr_const_void_ptr)(void  *rv_arg_27, void  *rv_arg_28);
...
int  vsprintf_0(char  *rv_arg_20, char  *rv_arg_21);
int  vprintf_0(char  *rv_arg_22);
int  vfprintf_0(FILE  *rv_arg_23, char  *rv_arg_24);
...
char  *memmove(char  *rv_arg_29, char  *rv_arg_30, size_t  rv_arg_31);
int  memcmp(char  *rv_arg_32, char  *rv_arg_33, size_t  rv_arg_34);
int  strncasecmp(char  *rv_arg_35, char  *rv_arg_36, size_t  rv_arg_37);
size_t  strcspn(char  *rv_arg_38, char  *rv_arg_39);
stack_t  *create_stack(unsigned int  item_length);
...
{
  {
    seatest_test_fixture_start("/cygdrive/c/gitrvt/test/betik/c5/a1.c");
  }
...
{
  {
    if (seatest_should_run("/cygdrive/c/gitrvt/test/betik/c5/a1.c","parser_test1"))
    {
      seatest_setup();
      parser_test1();
      seatest_teardown();
...
{
  {
    seatest_assert_int_equal(TT_NUMBER,get_token(*rvp_t),"<unknown>",804);
  }
...
{
  {
    seatest_assert_int_equal(TT_STRING,get_token(*rvp_t),"<unknown>",805);
  }
...
{
  {
    seatest_assert_int_equal(TT_NUMBER,get_token(*rvp_t),"<unknown>",806);
  }
...
{
  {
    seatest_assert_int_equal(TT_NUMBER,get_token(*rvp_t),"<unknown>",810);
  }
...
{
  {
    seatest_assert_int_equal(TT_STRING,get_token(*rvp_t),"<unknown>",811);
  }
...
{
  {
    seatest_assert_int_equal(TT_NUMBER,get_token(*rvp_t),"<unknown>",812);
  }
...
{
  {
    if (seatest_should_run("/cygdrive/c/gitrvt/test/betik/c5/a1.c","tokenizer_test1"))
    {
      seatest_setup();
      tokenizer_test1();
      seatest_teardown();
