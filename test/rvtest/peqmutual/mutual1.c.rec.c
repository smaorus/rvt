...
int  vsprintf_0(char  *rv_arg_7, char  *rv_arg_8);
int  vprintf_0(char  *rv_arg_9);
int  vfprintf_0(FILE  *rv_arg_10, char  *rv_arg_11);
...
unsigned char  Loop_main_while2(int  i, int  *rvp_rvretval);

unsigned char  Loop_main_for3(int  *rvp_i, int  *rvp_l, int  *rvp_rvretval);
...
int  main()
{
  ...
  i = 0;
  {
    switch (Loop_main_while2(i,&rvretval))
    {
    case 123:
      return rvretval;
    case 0:
...
unsigned char  Loop_main_for1(int  *rvp_i, int  *rvp_l, int  *rvp_rvretval)
{
  ...
  (*rvp_i)++;
  {
    return Loop_main_for1(rvp_i,rvp_l,rvp_rvretval);
  }
  return 0;
}
...
unsigned char  Loop_main_while2(int  i, int  *rvp_rvretval)
{
  ...
  {
    __CPROVER_printf_1("%2d",(long ) (F(i)));
    {
      return 123;
    }
  ...
  {
    return Loop_main_while2(i,rvp_rvretval);
  }
  return 0;
}
...
unsigned char  Loop_main_for3(int  *rvp_i, int  *rvp_l, int  *rvp_rvretval)
{
  ...
  (*rvp_i)++;
  {
    return Loop_main_for3(rvp_i,rvp_l,rvp_rvretval);
  }
  return 0;
}
